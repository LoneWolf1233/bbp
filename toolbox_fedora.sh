...
clear
echo "_
__________________   ________  .____   __________ ________  ____  ___                  
\__    ___/\_____  \  \_____  \ |    |  \______   \\_____  \ \   \/  /                  
  |    |    /   |   \  /   |   \|    |   |    |  _/ /   |   \ \     /                   
  |    |   /    |    \/    |    \    |___|    |   \/    |    \/     \                   
  |____|   \_______  /\_______  /_______ \______  /\_______  /___/\  \                  
                   \/         \/        \/      \/         \/      \_/                  
___.             _________                           .__ __      __.__                  
\_ |__ ___.__.  /   _____/ ____   ____   ______ ____ |__/  \    /  \  |__   ____  __ __ 
 | __ <   |  |  \_____  \_/ __ \ /    \ /  ___// __ \|  \   \/\/   /  |  \ /  _ \|  |  \
 | \_\ \___  |  /        \  ___/|   |  \\___ \\  ___/|  |\        /|   Y  (  <_> )  |  /
 |___  / ____| /_______  /\___  >___|  /____  >\___  >__| \__/\  / |___|  /\____/|____/ 
     \/\/              \/     \/     \/     \/     \/          \/       \/              
                         ________     _______                                           
                         \_____  \    \   _  \                                          
                          /  ____/    /  /_\  \                                         
...
sudo dnf install python3 python3-virtualenv python3-pip pipx git wget unzip perl curl npm nodejs jq make gcc -y
...
install_wafw00f() {
  ...
  if command -v wafw00f >/dev/null 2>&1; then
    ...
    if sudo dnf install -y wafw00f >/dev/null 2>&1; then
      ((num_choice++))
    else
...
install_nmap() {
  ...
  if command -v nmap >/dev/null 2>&1; then
    ...
    if sudo dnf install nmap >/dev/null 2>&1; then
      ((num_choice++))
    else
